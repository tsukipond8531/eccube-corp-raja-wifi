...
class CustomerController extends AbstractController
{
     ...
     * 会員CSVの出力.
     *
     * @Route("/%eccube_admin_route%/customer/export-pdf/{id}", requirements={"id" = "\d+"}, name="admin_customer_export_pdf", methods={"GET", "POST"})
     *
     * @param Request $request
     *
     * @return StreamedResponse
    ...
    public function exportPDF(Request $request, CustomerPdfService $customerPdfService)
    {
        ...
        $status = $customerPdfService->makePdf($Customer);
