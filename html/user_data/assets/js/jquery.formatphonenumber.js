...
(function(factory) {
    ...
    var FormatPhoneNumber = {
        init: function(el, options, flag) {
            this.el = el;
            this.format = options.format;
            this.validFormat = '#-() +';
			this.flag = flag;

            if (this.validateFormat() && this.flag) {
                this.bindEvents();
            }
        },
    ...
    $.fn.formatPhoneNumber = function(options, flag = true) {
       var formatPhoneNumber = Object.create(FormatPhoneNumber);
       formatPhoneNumber.init(this, $.extend({}, {format: '###-###-####'}, options), flag);
    };
}));