...
class ChangeController extends AbstractController
{
     ...
     * @Route("/mypage/change", name="mypage_change_confirm", methods={"GET", "POST"})
     * @Route("/mypage/change", name="mypage_change_complete", methods={"GET", "POST"})
    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            switch ($request->get('mode')) {
                case 'confirm':
                    return $this->render('Mypage/change_confirm.twig', [
                        'form' => $form->createView(),
                        'Page' => $this->pageRepository->getPageByRoute('mypage_change_confirm'),
                    ]);
                case 'complete':
                    log_info('会員編集開始');
                    ...
                    return $this->render('Mypage/change_complete.twig', [
                        'form' => $form->createView(),
                        'Page' => $this->pageRepository->getPageByRoute('mypage_change_complete'),
                    ]);
            }
        }
